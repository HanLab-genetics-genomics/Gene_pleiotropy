...
* [Matched-gene permutation analyses](https://github.com/HanLab-genetics-genomics/Gene_pleiotropy/blob/main/Scripts/11.2%20matched_permutation_analysis.R): Matched-gene permutation analyses in Supplementary Notes
...
The first step [11.1 run_matched_permutation.R](https://github.com/HanLab-genetics-genomics/Gene_pleiotropy/blob/main/Scripts/11.1%20run_matched_permutation.R) is computationally intensive because it performs matched sampling across the gene universe and 1,000 permutations. For convenience, we provide the output files generated by step 11.1: [matched_ctrl_mat_pn.rds](https://github.com/HanLab-genetics-genomics/Gene_pleiotropy/blob/main/Output/permutation/matched_ctrl_mat_pn.rds) and [matched_ctrl_mat_pm.rds](https://github.com/HanLab-genetics-genomics/Gene_pleiotropy/blob/main/Output/permutation/matched_ctrl_mat_pm.rds). Therefore, users who want to reproduce the final matched-permutation summary table can skip step 11.1 and directly run step 11.2.
