...
figure_file <- "/path/to/Gene_pleiotropy-main/Output/Figure7"
...
ggsave(plot = percent_fda$pleio_n, width = 6, height = 5, device = cairo_pdf,
       filename = sprintf("%s/figure7_percent_fda_pn.pdf",figure_file))
...
ggsave(plot = forest_plot_list$pn, width = 7, height = 4.5, device = cairo_pdf,
       filename = sprintf("%s/figure7_forest_combined_pn.pdf",figure_file))
...
ggsave(plot = plotline_plot_list$pn, width = 6, height = 4, device = cairo_pdf,
       filename = sprintf("%s/figure7_plotline_pn.pdf",figure_file))
